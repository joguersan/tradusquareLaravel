...
@section('contenido')
  ...
  <ul class="list-group d-flex text-left">
      ...
      <li class="list-group-item pl-5 bg-light"><span class="badge badge-primary text-black badge-pill mr-3">10a</span>Por ello, el grupo responsable de cada parche se guarda el derecho de proporcionar soporte o asistencia en caso de que se esté usando una copia no legal para aplicarlo.</li>

...
<div class="text-center">
    <img loading="lazy" src="images/noticias.webp" class="titular w-50 mb-2" alt="Últimas noticias">
</div>
<div class="row">
    <?php $i = 0 ?>
    ...
    <div class="col-md-4 mb-3">
        <a href="{{ route('noticia.show', $noticia->url) }}" class="overflow-y-hidden card bg-dark text-white cartaNoticia">
            <img loading="lazy" style="height:250px" class="card-img lazy" src="{{$noticia->imagen}}" alt="Imagen destacada: {{$noticia->titulo}}" />

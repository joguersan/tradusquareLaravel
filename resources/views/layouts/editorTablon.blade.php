                    ...
                    <div class="card-body">
                        <form class="pb-3" method="post" action="@yield('action')">
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend">
                                        <label class="btn btn-dark">Correo de contacto:</label>
                                    </div>
                                    <input type="text" name="contacto" class="form-control" value="@yield('campoContacto')" aria-label="Default" placeholder="tradusquare@gmail.com"></input>
                                </div>
                                {{$errors->first('imagen')}}
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="juegos w-75" name="fichas" class="form-control">
                                        @yield('campoFichas')
                                    </select>
                                </div>

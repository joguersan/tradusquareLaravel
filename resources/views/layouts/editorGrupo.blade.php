                            ...
                            <div class="form-row">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="imagen" class="form-control" value="@yield('campoImagen')" aria-label="Default" placeholder="O inserta URL del logo"></input>
                                </div>
                                {{$errors->first('imagen')}}
                              </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col mb-2">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="twitter" value="@yield('facebook')" id="facebook" placeholder="tradusquare"></input>
                                    </div>
                                  </div>
                                  <div class="col mb-2">
                                    <div class="input-group-prepend">
